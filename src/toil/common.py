...
def addOptions(parser: ArgumentParser, config: Optional[Config] = None) -> None:
    ...
    resource_options.add_argument('--defaultPartition', dest='defaultPartition', default=None, metavar='STR', type=str, nargs="?", const=True,
